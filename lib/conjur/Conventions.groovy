...
class Conventions {
  ...
  static void addGitRepo(Job job, String repoUrl, boolean triggerOnPush=true, String branch='') {
    job.with {
      parameters {
        stringParam('BRANCH', branch, 'Git branch or SHA to build. Not required.')
      }
